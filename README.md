...
[![Version](https://img.shields.io/badge/version-1.1.6-e8a33d)](https://github.com/MishaSok/audex-player/releases/latest)
...
| Platform | File |
| --- | --- |
| **Linux** | `Audex-1.1.6.AppImage` (portable) or `audex-player_1.1.6_amd64.deb` |
| **macOS** (Apple Silicon) | `Audex-1.1.6-arm64.dmg` |
| **Windows** | `Audex.Setup.1.1.6.exe` |
